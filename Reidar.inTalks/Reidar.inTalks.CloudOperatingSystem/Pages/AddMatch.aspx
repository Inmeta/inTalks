...
<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <div>
        <div>Home team: <input type="text" id="home" /></div>
        <div>Away team: <input type="text" id="away" /></div>
        <div>Home score: <input type="text" id="homeScore" /></div>
        <div>Away score: <input type="text" id="awayScore" /></div>
        <p>
